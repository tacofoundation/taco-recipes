...
# Collection metadata
COLLECTION_ID = "cloud3d-pretraining-goes"
COLLECTION_VERSION = "0.1.0"
COLLECTION_DESCRIPTION = (
    "GOES (Geostationary Operational Environmental Satellite) imagery subset from "
    "the Global 3D Cloud Reconstruction Dataset. Contains multispectral geostationary "
    "satellite imagery from GOES-16/ABI for 3D cloud structure reconstruction. "
    "Each sample contains 20 bands: 16 spectral channels plus satellite and solar angles. "
...
COLLECTION_TITLE = "Cloud 3D - GOES Pretraining Dataset"
COLLECTION_KEYWORDS = [
    "cloud microphysics",
    "3d reconstruction",
...
# Output settings
OUTPUT_PATH = "/data/databases/CLOUD_3D/pretraining/tacos/pretraining/goes/goes.tacozip"
...
# Documentation
GENERATE_DOCS = True
DOWNLOAD_BASE_URL = "https://source.coop/taco/3dclouds/pretraining/goes/"
CATALOGUE_URL = "https://tacofoundation.github.io/catalogue"
THEME_COLOR = "#3498db"
DATASET_EXAMPLE_PATH = "https://data.source.coop/taco/3dclouds/pretraining/goes/"
