...
# Collection metadata
COLLECTION_ID = "cloud3d-pretraining-himawari"
COLLECTION_VERSION = "0.1.0"
COLLECTION_DESCRIPTION = (
    "Himawari-8 imagery subset from the Global 3D Cloud Reconstruction Dataset. "
    "Contains multispectral geostationary satellite imagery from Himawari-8/AHI "
    "for 3D cloud structure reconstruction. Each sample contains 16 spectral channels. "
    "512x512 pixel patches in Cloud-Optimized GeoTIFF format."
)
COLLECTION_LICENSES = ["CC-BY-4.0"]
COLLECTION_PROVIDERS = [
    Provider(name="Japan Meteorological Agency (JMA)", roles=["producer"], url="https://www.jma.go.jp"),
...
COLLECTION_TITLE = "Cloud 3D - Himawari-8 Pretraining Dataset"
COLLECTION_KEYWORDS = [
    "cloud microphysics",
    "3d reconstruction",
...
# Output settings
OUTPUT_PATH = "/data/databases/CLOUD_3D/pretraining/tacos/pretraining/himawari/himawari.tacozip"
...
# Documentation
GENERATE_DOCS = True
DOWNLOAD_BASE_URL = "https://source.coop/taco/3dclouds/pretraining/himawari/"
CATALOGUE_URL = "https://tacofoundation.github.io/catalogue"
THEME_COLOR = "#3498db"
DATASET_EXAMPLE_PATH = "https://data.source.coop/taco/3dclouds/pretraining/himawari/"
