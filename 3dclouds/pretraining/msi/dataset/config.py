...
# Collection metadata
COLLECTION_ID = "cloud3d-pretraining-msg"
COLLECTION_VERSION = "0.1.0"
COLLECTION_DESCRIPTION = (
    "MSG (Meteosat Second Generation) imagery subset from the Global 3D Cloud "
    "Reconstruction Dataset. Contains multispectral geostationary satellite imagery "
    "from MSG/SEVIRI for 3D cloud structure reconstruction. Each sample contains "
    "12 spectral channels. 512x512 pixel patches in Cloud-Optimized GeoTIFF format."
)
...
COLLECTION_TITLE = "Cloud 3D - MSG Pretraining Dataset"
COLLECTION_KEYWORDS = [
    "cloud microphysics",
    "3d reconstruction",
...
# Output settings
OUTPUT_PATH = "/data/databases/CLOUD_3D/pretraining/tacos/pretraining/msg/msg.tacozip"
...
# Documentation
GENERATE_DOCS = True
DOWNLOAD_BASE_URL = "https://source.coop/taco/3dclouds/pretraining/msg/"
CATALOGUE_URL = "https://tacofoundation.github.io/catalogue"
THEME_COLOR = "#3498db"
DATASET_EXAMPLE_PATH = "https://data.source.coop/taco/3dclouds/pretraining/msg/"
