...
# Collection metadata
COLLECTION_ID = "cloud3d-finetune-msi"
COLLECTION_VERSION = "0.1.0"
COLLECTION_DESCRIPTION = (
    "MSG/SEVIRI finetuning subset from the Global 3D Cloud Reconstruction Dataset. "
    "Contains colocated pairs of Meteosat Second Generation (MSG) SEVIRI geostationary "
    "imagery with CloudSat radar profiles for supervised 3D cloud structure reconstruction. "
    "Each sample includes: multispectral SEVIRI imagery (12 spectral channels + satellite/solar "
    "angles), CloudSat vertical profiles as ground truth, and a colocation mask indicating "
    "valid CloudSat footprint pixels. 256x256 pixel patches in Cloud-Optimized GeoTIFF format. "
    "Temporal coverage spans 2006-2020, providing the longest continuous record among the "
    "three geostationary sensors in the Cloud3D dataset."
)
COLLECTION_LICENSES = ["CC-BY-4.0"]
COLLECTION_PROVIDERS = [
    Provider(name="EUMETSAT", roles=["producer"], url="https://www.eumetsat.int"),
...
COLLECTION_TITLE = "Cloud 3D - MSG/SEVIRI Finetuning Dataset"
COLLECTION_KEYWORDS = [
    "cloud microphysics",
    "3d reconstruction",
...
# Output settings
OUTPUT_PATH = "/data/databases/CLOUD_3D/pretraining/tacos/finetune/msi/msi.tacozip"
...
# Documentation
GENERATE_DOCS = True
DOWNLOAD_BASE_URL = "https://source.coop/taco/3dclouds/finetune/msi/"
CATALOGUE_URL = "https://tacofoundation.github.io/catalogue"
THEME_COLOR = "#3498db"
DATASET_EXAMPLE_PATH = "https://data.source.coop/taco/3dclouds/finetune/msi/"
