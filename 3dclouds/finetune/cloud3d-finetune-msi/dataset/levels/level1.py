...
def build_sample_geo_patch(ctx: dict) -> Sample:
    """
    MSG/SEVIRI geostationary imagery.
    
    16 bands total:
        - 11 spectral channels (VIS006, VIS008, IR_016, IR_039, WV_062, 
          WV_073, IR_087, IR_097, IR_108, IR_120, IR_134)
        - 4 geometry bands (satellite/solar azimuth & zenith angles)
        - 1 CloudSat overpass mask
...
def build_sample_cloudsat(ctx: dict) -> Sample:
    ...
    8 bands total:
        - CPR_Cloud_mask, Radar_Reflectivity, CloudTypeMask
        - re (effective radius), IWC (ice water content)
        - RO_liq_water_content, RO_ice_water_content
        - Height (vertical levels)
