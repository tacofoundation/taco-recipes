...
# Collection metadata
COLLECTION_ID = "cloud3d-finetune-goes"
COLLECTION_VERSION = "0.1.0"
COLLECTION_DESCRIPTION = (
    "GOES finetuning subset from the Global 3D Cloud Reconstruction Dataset. "
    "Contains colocated pairs of GOES/ABI geostationary imagery with CloudSat "
    "radar profiles for supervised 3D cloud structure reconstruction. Each sample "
    "includes: multispectral GOES imagery (16 spectral channels + satellite/solar angles), "
...
COLLECTION_TITLE = "Cloud 3D - GOES Finetuning Dataset"
COLLECTION_KEYWORDS = [
    "cloud microphysics",
    "3d reconstruction",
...
# Output settings
OUTPUT_PATH = "/data/databases/CLOUD_3D/pretraining/tacos/finetune/goes/goes.tacozip"
...
# Documentation
GENERATE_DOCS = True
DOWNLOAD_BASE_URL = "https://source.coop/taco/3dclouds/finetune/goes/"
CATALOGUE_URL = "https://tacofoundation.github.io/catalogue"
THEME_COLOR = "#3498db"
DATASET_EXAMPLE_PATH = "https://data.source.coop/taco/3dclouds/finetune/goes/"
